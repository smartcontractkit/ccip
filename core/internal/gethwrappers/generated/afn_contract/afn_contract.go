...
func (_AFNContract *AFNContractCaller) IsBlessed(opts *bind.CallOpts, root [32]byte) (bool, error) {
	var out []interface{}
	err := _AFNContract.contract.Call(opts, &out, "isBlessed", root)
...
func (_AFNContract *AFNContractSession) IsBlessed(root [32]byte) (bool, error) {
	return _AFNContract.Contract.IsBlessed(&_AFNContract.CallOpts, root)
}

func (_AFNContract *AFNContractCallerSession) IsBlessed(root [32]byte) (bool, error) {
	return _AFNContract.Contract.IsBlessed(&_AFNContract.CallOpts, root)
}
