...
func (_SimpleMessageReceiver *SimpleMessageReceiverCaller) GetMessage(opts *bind.CallOpts) (CCIPAnyToEVMTollMessage, error) {
	var out []interface{}
	err := _SimpleMessageReceiver.contract.Call(opts, &out, "getMessage")

	if err != nil {
		return *new(CCIPAnyToEVMTollMessage), err
	}

	out0 := *abi.ConvertType(out[0], new(CCIPAnyToEVMTollMessage)).(*CCIPAnyToEVMTollMessage)

	return out0, err

}

func (_SimpleMessageReceiver *SimpleMessageReceiverSession) GetMessage() (CCIPAnyToEVMTollMessage, error) {
	return _SimpleMessageReceiver.Contract.GetMessage(&_SimpleMessageReceiver.CallOpts)
}

func (_SimpleMessageReceiver *SimpleMessageReceiverCallerSession) GetMessage() (CCIPAnyToEVMTollMessage, error) {
	return _SimpleMessageReceiver.Contract.GetMessage(&_SimpleMessageReceiver.CallOpts)
}
...
func (_SimpleMessageReceiver *SimpleMessageReceiverTransactor) ReceiveMessage(opts *bind.TransactOpts, message CCIPAnyToEVMTollMessage) (*types.Transaction, error) {
	return _SimpleMessageReceiver.contract.Transact(opts, "receiveMessage", message)
}

func (_SimpleMessageReceiver *SimpleMessageReceiverSession) ReceiveMessage(message CCIPAnyToEVMTollMessage) (*types.Transaction, error) {
	return _SimpleMessageReceiver.Contract.ReceiveMessage(&_SimpleMessageReceiver.TransactOpts, message)
}

func (_SimpleMessageReceiver *SimpleMessageReceiverTransactorSession) ReceiveMessage(message CCIPAnyToEVMTollMessage) (*types.Transaction, error) {
	return _SimpleMessageReceiver.Contract.ReceiveMessage(&_SimpleMessageReceiver.TransactOpts, message)
}
...
type SimpleMessageReceiverMessageReceived struct {
	Message CCIPAnyToEVMTollMessage
	Raw     types.Log
}
...
type SimpleMessageReceiverInterface interface {
	GetMessage(opts *bind.CallOpts) (CCIPAnyToEVMTollMessage, error)
