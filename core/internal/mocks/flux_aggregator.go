...
// NewFluxAggregator creates a new instance of FluxAggregator. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewFluxAggregator(t testing.TB) *FluxAggregator {
	mock := &FluxAggregator{}
	mock.Mock.Test(t)
