...
// NewFlags creates a new instance of Flags. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewFlags(t testing.TB) *Flags {
	mock := &Flags{}
	mock.Mock.Test(t)
