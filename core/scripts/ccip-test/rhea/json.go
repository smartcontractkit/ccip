...
var Prod_GoerliToOptimism = EvmChainConfig{
...
var Prod_OptimismToGoerli = EvmChainConfig{
...
var Prod_GoerliToAvaxFuji = EvmChainConfig{
	ChainId: big.NewInt(5),
	EthUrl:  secrets.GoerliEthURL,
	GasSettings: EVMGasSettings{
		EIP1559:   true,
...
var Prod_AvaxFujiToGoerli = EvmChainConfig{
...
var Staging_Beta_GoerliToAvaxFuji = EvmChainConfig{
	ChainId: big.NewInt(5),
	EthUrl:  secrets.GoerliEthURL,
	GasSettings: EVMGasSettings{
		EIP1559:   true,
...
var Staging_Beta_AvaxFujiToGoerli = EvmChainConfig{
	ChainId: big.NewInt(43113),
	EthUrl:  secrets.AvaxFujiURL,
	GasSettings: EVMGasSettings{
		EIP1559: false,
