...
type NodeOperatorUI interface {
	...
	// capability that the core node already supports. i.e. already added by the CapabilityAuthorUI
	AddCapability(cfg []byte) (id int, err error)
