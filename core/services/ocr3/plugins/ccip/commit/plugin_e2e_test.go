...
func setupAllNodesReadAllChains(ctx context.Context, t *testing.T, lggr logger.Logger) []nodeSetup {
	...
	for _, n := range nodes {
		...
		n.ccipReader.On(
			...
			{CCIPMsgBaseDetails: cciptypes.CCIPMsgBaseDetails{ID: "1", SourceChain: chainB, SeqNum: 21}},
			{CCIPMsgBaseDetails: cciptypes.CCIPMsgBaseDetails{ID: "2", SourceChain: chainB, SeqNum: 22}},
		}, nil)
...
func setupNodesDoNotAgreeOnMsgs(ctx context.Context, t *testing.T, lggr logger.Logger) []nodeSetup {
	...
	for i, n := range nodes {
		...
		n.ccipReader.On(
			...
			{CCIPMsgBaseDetails: cciptypes.CCIPMsgBaseDetails{ID: "1" + strconv.Itoa(i), SourceChain: chainB, SeqNum: 21 + cciptypes.SeqNum(i*10)}},
			{CCIPMsgBaseDetails: cciptypes.CCIPMsgBaseDetails{ID: "2" + strconv.Itoa(i), SourceChain: chainB, SeqNum: 22 + cciptypes.SeqNum(i*20)}},
		}, nil)
