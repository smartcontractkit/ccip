...
func (_m *CCIPTransactionStatusChecker) CheckMessageStatus(ctx context.Context, msgID string) ([]statuschecker.TransactionStatusWithError, int, error) {
	...
	var r0 []statuschecker.TransactionStatusWithError
	var r1 int
	var r2 error
	if rf, ok := ret.Get(0).(func(context.Context, string) ([]statuschecker.TransactionStatusWithError, int, error)); ok {
		return rf(ctx, msgID)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string) []statuschecker.TransactionStatusWithError); ok {
		r0 = rf(ctx, msgID)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]statuschecker.TransactionStatusWithError)
		}
	}
...
func (_c *CCIPTransactionStatusChecker_CheckMessageStatus_Call) Return(transactionStatuses []statuschecker.TransactionStatusWithError, retryCounter int, err error) *CCIPTransactionStatusChecker_CheckMessageStatus_Call {
	_c.Call.Return(transactionStatuses, retryCounter, err)
	return _c
}

func (_c *CCIPTransactionStatusChecker_CheckMessageStatus_Call) RunAndReturn(run func(context.Context, string) ([]statuschecker.TransactionStatusWithError, int, error)) *CCIPTransactionStatusChecker_CheckMessageStatus_Call {
	_c.Call.Return(run)
	return _c
}
