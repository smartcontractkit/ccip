...
func TestMarshalReportMetadata(t *testing.T) {
	...
	t.Run("unmarshal onchain", func(t *testing.T) {
		...
		report, instructions, err := models.DecodeReport(
			909606746561742123,
			models.Address(common.HexToAddress("0x2033C546BC60900f8B765F0a8e7E2376a17cba5d")),
			encodedReport)
		require.NoError(t, err)
		t.Log("instructions:", instructions)
		t.Log("report:", report)

		encodedReport = hexutil.MustDecode("")
		report, instructions, err = models.DecodeReport(
			3379446385462418246,
			models.Address(common.HexToAddress("0x2033C546BC60900f8B765F0a8e7E2376a17cba5d")),
			encodedReport)
