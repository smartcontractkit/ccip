...
func Test_testBridge_toPendingTransfers(t *testing.T) {
	var (
		...
		localToken            = models.Address(common.HexToAddress("0xabc"))
		remoteToken           = models.Address(common.HexToAddress("0xdef"))
		sourceAdapterAddress  = models.Address(common.HexToAddress("0x1"))
		destRebalancerAddress = models.Address(common.HexToAddress("0x2"))
	)
