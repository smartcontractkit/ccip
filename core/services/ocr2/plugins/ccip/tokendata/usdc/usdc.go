...
import (
	...
	"github.com/smartcontractkit/chainlink/v2/core/services/ocr2/plugins/ccip/internal/chains"
...
var tokenMapping = map[chains.EVMChain]common.Address{
	// Mainnet
	chains.Ethereum:  common.HexToAddress("0xa0b86991c6218b36c1d19d4a2e9eb0ce3606eb48"),
	chains.Optimism:  common.HexToAddress("0x0b2c639c533813f4aa9d7837caf62653d097ff85"),
	chains.Arbitrum:  common.HexToAddress("0xaf88d065e77c8cc2239327c5edb3a432268e5831"),
	chains.Avalanche: common.HexToAddress("0xb97ef9ef8734c71904d8002f8b6bc66dd9c48a6e"),

	// Testnets
	chains.GoerliTestnet:         common.HexToAddress("0xca6b4c00831ffb77afe22e734a6101b268b7fcbe"),
	chains.OptimismGoerliTestnet: common.HexToAddress("0xe05606174bac4A6364B31bd0eCA4bf4dD368f8C6"),
	chains.AvalancheFujiTestnet:  common.HexToAddress("0x5425890298aed601595a70ab815c96711a31bc65"),
	chains.ArbitrumGoerliTestnet: common.HexToAddress("0xfd064A18f3BF249cf1f87FC203E90D8f650f2d63"),
}

func GetUSDCTokenAddress(chain uint64) (common.Address, error) {
	if tokenAddress, ok := tokenMapping[chains.EVMChain(chain)]; ok {
		return tokenAddress, nil
	}
	return common.Address{}, errors.New("token not found")
}

var messageTransmitterMapping = map[chains.EVMChain]common.Address{
	// Mainnet
	chains.Ethereum:  common.HexToAddress("0x0a992d191deec32afe36203ad87d7d289a738f81"),
	chains.Optimism:  common.HexToAddress("0x4d41f22c5a0e5c74090899e5a8fb597a8842b3e8"),
	chains.Arbitrum:  common.HexToAddress("0xC30362313FBBA5cf9163F0bb16a0e01f01A896ca"),
	chains.Avalanche: common.HexToAddress("0x8186359af5f57fbb40c6b14a588d2a59c0c29880"),

	// Testnets
	chains.GoerliTestnet:         common.HexToAddress("0xca6b4c00831ffb77afe22e734a6101b268b7fcbe"),
	chains.OptimismGoerliTestnet: common.HexToAddress("0x9ff9a4da6f2157a9c82ce756f8fd7e0d75be8895"),
	chains.AvalancheFujiTestnet:  common.HexToAddress("0xa9fb1b3009dcb79e2fe346c16a604b8fa8ae0a79"),
	chains.ArbitrumGoerliTestnet: common.HexToAddress("0x109bc137cb64eab7c0b1dddd1edf341467dc2d35"),
}

func GetUSDCMessageTransmitterAddress(chain uint64) (common.Address, error) {
	if transmitterAddress, ok := messageTransmitterMapping[chains.EVMChain(chain)]; ok {
...
func NewUSDCTokenDataReader(sourceChainEvents ccipdata.Reader, usdcTokenAddress, onRampAddress common.Address, usdcAttestationApi *url.URL, sourceChainId uint64) *TokenDataReader {
	return &TokenDataReader{
		...
		messageTransmitter:   messageTransmitterMapping[chains.EVMChain(sourceChainId)],
