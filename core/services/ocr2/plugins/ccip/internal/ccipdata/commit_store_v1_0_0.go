...
func (c *CommitStoreV1_0_0) GetAcceptedCommitReportsGteTimestampV2(ctx context.Context, offrampAddress common.Address, ts time.Time, confs int) ([]Event[CommitStoreReport], error) {
