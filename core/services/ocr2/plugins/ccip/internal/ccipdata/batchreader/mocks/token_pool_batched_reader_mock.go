...
// TokenPoolBatchedReaderInterface is an autogenerated mock type for the TokenPoolBatchedReaderInterface type
type TokenPoolBatchedReaderInterface struct {
	mock.Mock
}

// GetInboundTokenPoolRateLimits provides a mock function with given fields: ctx, tokenPoolReaders
func (_m *TokenPoolBatchedReaderInterface) GetInboundTokenPoolRateLimits(ctx context.Context, tokenPoolReaders []common.Address) ([]ccipdata.TokenBucketRateLimit, error) {
...
// NewTokenPoolBatchedReaderInterface creates a new instance of TokenPoolBatchedReaderInterface. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewTokenPoolBatchedReaderInterface(t interface {
	mock.TestingT
	Cleanup(func())
}) *TokenPoolBatchedReaderInterface {
	mock := &TokenPoolBatchedReaderInterface{}
	mock.Mock.Test(t)
