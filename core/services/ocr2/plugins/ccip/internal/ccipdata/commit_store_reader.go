...
func NewCommitStoreReader(lggr logger.Logger, address common.Address, ec client.Client, lp logpoller.LogPoller, estimator gas.EvmFeeEstimator, jobID int32) (CommitStoreReader, error) {
	...
	case V1_0_0, V1_1_0:
		...
		return NewCommitStoreV1_0_0(lggr, address, ec, lp, estimator, jobID)
	case V1_2_0:
		return NewCommitStoreV1_2_0(lggr, address, ec, lp, estimator, jobID)
	default:
