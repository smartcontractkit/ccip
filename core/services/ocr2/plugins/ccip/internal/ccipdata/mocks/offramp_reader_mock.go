...
// GetMessageVisibilityInterval provides a mock function with given fields:
func (_m *OffRampReader) GetMessageVisibilityInterval() time.Duration {
	ret := _m.Called()

	if len(ret) == 0 {
		panic("no return value specified for GetMessageVisibilityInterval")
	}
