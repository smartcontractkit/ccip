...
func (_m *OffRampReader) DecodeExecutionReport(report []byte) (offramp.ExecReport, error) {
	ret := _m.Called(report)

	var r0 offramp.ExecReport
	var r1 error
	if rf, ok := ret.Get(0).(func([]byte) (offramp.ExecReport, error)); ok {
		return rf(report)
	}
	if rf, ok := ret.Get(0).(func([]byte) offramp.ExecReport); ok {
		r0 = rf(report)
	} else {
		r0 = ret.Get(0).(offramp.ExecReport)
	}
...
func (_m *OffRampReader) EncodeExecutionReport(report offramp.ExecReport) ([]byte, error) {
	ret := _m.Called(report)

	var r0 []byte
	var r1 error
	if rf, ok := ret.Get(0).(func(offramp.ExecReport) ([]byte, error)); ok {
		return rf(report)
	}
	if rf, ok := ret.Get(0).(func(offramp.ExecReport) []byte); ok {
		r0 = rf(report)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]byte)
	...
	if rf, ok := ret.Get(1).(func(offramp.ExecReport) error); ok {
		r1 = rf(report)
	} else {
		r1 = ret.Error(1)
	}
...
func (_m *OffRampReader) GetExecutionStateChangesBetweenSeqNums(ctx context.Context, seqNumMin uint64, seqNumMax uint64, confs int) ([]ccipdata.Event[offramp.ExecutionStateChanged], error) {
	ret := _m.Called(ctx, seqNumMin, seqNumMax, confs)

	var r0 []ccipdata.Event[offramp.ExecutionStateChanged]
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, uint64, uint64, int) ([]ccipdata.Event[offramp.ExecutionStateChanged], error)); ok {
		return rf(ctx, seqNumMin, seqNumMax, confs)
	}
	if rf, ok := ret.Get(0).(func(context.Context, uint64, uint64, int) []ccipdata.Event[offramp.ExecutionStateChanged]); ok {
		r0 = rf(ctx, seqNumMin, seqNumMax, confs)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]ccipdata.Event[offramp.ExecutionStateChanged])
		}
	}
...
func (_m *OffRampReader) GetStaticConfig(ctx context.Context) (offramp.OffRampStaticConfig, error) {
	ret := _m.Called(ctx)

	var r0 offramp.OffRampStaticConfig
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context) (offramp.OffRampStaticConfig, error)); ok {
		return rf(ctx)
	}
	if rf, ok := ret.Get(0).(func(context.Context) offramp.OffRampStaticConfig); ok {
		r0 = rf(ctx)
	} else {
		r0 = ret.Get(0).(offramp.OffRampStaticConfig)
	}
...
func (_m *OffRampReader) GetTokenPoolsRateLimits(ctx context.Context, poolAddresses []common.Address) ([]offramp.TokenBucketRateLimit, error) {
	ret := _m.Called(ctx, poolAddresses)

	var r0 []offramp.TokenBucketRateLimit
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, []common.Address) ([]offramp.TokenBucketRateLimit, error)); ok {
		return rf(ctx, poolAddresses)
	}
	if rf, ok := ret.Get(0).(func(context.Context, []common.Address) []offramp.TokenBucketRateLimit); ok {
		r0 = rf(ctx, poolAddresses)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]offramp.TokenBucketRateLimit)
		}
	}
...
func (_m *OffRampReader) OffchainConfig() offramp.ExecOffchainConfig {
	ret := _m.Called()

	var r0 offramp.ExecOffchainConfig
	if rf, ok := ret.Get(0).(func() offramp.ExecOffchainConfig); ok {
		r0 = rf()
	} else {
		r0 = ret.Get(0).(offramp.ExecOffchainConfig)
	}
...
func (_m *OffRampReader) OnchainConfig() offramp.ExecOnchainConfig {
	ret := _m.Called()

	var r0 offramp.ExecOnchainConfig
	if rf, ok := ret.Get(0).(func() offramp.ExecOnchainConfig); ok {
		r0 = rf()
	} else {
		r0 = ret.Get(0).(offramp.ExecOnchainConfig)
	}
