...
func (_m *OnRampReader) GetDynamicConfig() (onramp.OnRampDynamicConfig, error) {
	ret := _m.Called()

	var r0 onramp.OnRampDynamicConfig
	var r1 error
	if rf, ok := ret.Get(0).(func() (onramp.OnRampDynamicConfig, error)); ok {
		return rf()
	}
	if rf, ok := ret.Get(0).(func() onramp.OnRampDynamicConfig); ok {
		r0 = rf()
	} else {
		r0 = ret.Get(0).(onramp.OnRampDynamicConfig)
	}
