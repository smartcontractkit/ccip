...
func (_m *PriceRegistryReader) GetGasPriceUpdatesCreatedAfter(ctx context.Context, chainSelector uint64, ts time.Time, confs int) ([]ccipdata.Event[price_registry.GasPriceUpdate], error) {
	ret := _m.Called(ctx, chainSelector, ts, confs)

	var r0 []ccipdata.Event[price_registry.GasPriceUpdate]
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, uint64, time.Time, int) ([]ccipdata.Event[price_registry.GasPriceUpdate], error)); ok {
		return rf(ctx, chainSelector, ts, confs)
	}
	if rf, ok := ret.Get(0).(func(context.Context, uint64, time.Time, int) []ccipdata.Event[price_registry.GasPriceUpdate]); ok {
		r0 = rf(ctx, chainSelector, ts, confs)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]ccipdata.Event[price_registry.GasPriceUpdate])
		}
	}
...
func (_m *PriceRegistryReader) GetTokenPriceUpdatesCreatedAfter(ctx context.Context, ts time.Time, confs int) ([]ccipdata.Event[price_registry.TokenPriceUpdate], error) {
	ret := _m.Called(ctx, ts, confs)

	var r0 []ccipdata.Event[price_registry.TokenPriceUpdate]
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, time.Time, int) ([]ccipdata.Event[price_registry.TokenPriceUpdate], error)); ok {
		return rf(ctx, ts, confs)
	}
	if rf, ok := ret.Get(0).(func(context.Context, time.Time, int) []ccipdata.Event[price_registry.TokenPriceUpdate]); ok {
		r0 = rf(ctx, ts, confs)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]ccipdata.Event[price_registry.TokenPriceUpdate])
		}
	}
...
func (_m *PriceRegistryReader) GetTokenPrices(ctx context.Context, wantedTokens []common.Address) ([]price_registry.TokenPriceUpdate, error) {
	ret := _m.Called(ctx, wantedTokens)

	var r0 []price_registry.TokenPriceUpdate
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, []common.Address) ([]price_registry.TokenPriceUpdate, error)); ok {
		return rf(ctx, wantedTokens)
	}
	if rf, ok := ret.Get(0).(func(context.Context, []common.Address) []price_registry.TokenPriceUpdate); ok {
		r0 = rf(ctx, wantedTokens)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]price_registry.TokenPriceUpdate)
		}
	}
