...
func NewObservedEVM2EVMnRamp(address common.Address, backend bind.ContractBackend) (evm_2_evm_onramp.EVM2EVMOnRampInterface, error) {
...
func (o *ObservedEVM2EVMOnramp) GetDynamicConfig(opts *bind.CallOpts) (evm_2_evm_onramp.EVM2EVMOnRampDynamicConfig, error) {
	return withObservedContract(o.histogram, "GetDynamicConfig", func() (evm_2_evm_onramp.EVM2EVMOnRampDynamicConfig, error) {
