...
// srcCommitStoreReader should be a IncompleteSourceCommitStoreReader impl.
// dstCommitStoreReader should be a IncompleteDestCommitStoreReader impl.
...
type ProviderProxyCommitStoreReader struct {
	srcCommitStoreReader cciptypes.CommitStoreReader
	dstCommitStoreReader cciptypes.CommitStoreReader
}
