...
func EncodeExecutionReport(execReport evm_2_evm_offramp.InternalExecutionReport) (types.Report, error) {
	return abihelpers.MakeExecutionReportArgs().PackValues([]interface{}{&execReport})
}
