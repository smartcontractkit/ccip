...
func TestObservationFilter(t *testing.T) {
	...
	nonEmpty, _ := getParsableObservations[CommitObservation](lggr, []types.AttributedObservation{{Observation: b1}, {Observation: []byte{}}})
...
func TestExecutionObservationJsonDeserialization(t *testing.T) {
	...
	observations, _ := getParsableObservations[ExecutionObservation](logger.TestLogger(t), []types.AttributedObservation{{Observation: []byte(json)}})
