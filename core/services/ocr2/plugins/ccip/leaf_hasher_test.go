...
func TestTollHasher(t *testing.T) {
	...
	message := evm_2_evm_toll_onramp.TollEVM2EVMTollMessage{
		...
		Data:              []byte{},
		TokensAndAmounts:  []evm_2_evm_toll_onramp.CommonEVMTokenAndAmount{{Token: common.HexToAddress("0x4440000000000000000000000000000000000001"), Amount: big.NewInt(12345678900)}},
		GasLimit:          big.NewInt(100),
		FeeTokenAndAmount: evm_2_evm_toll_onramp.CommonEVMTokenAndAmount{Token: common.HexToAddress("0x3330000000000000000000000000000000000001"), Amount: big.NewInt(987654321)},
	}
	...
	message = evm_2_evm_toll_onramp.TollEVM2EVMTollMessage{
		...
		TokensAndAmounts: []evm_2_evm_toll_onramp.CommonEVMTokenAndAmount{
...
func generateTollLog(t *testing.T, message evm_2_evm_toll_onramp.TollEVM2EVMTollMessage) types.Log {
