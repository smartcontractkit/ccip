...
// BootstrapP2PIDs provides a mock function with given fields:
func (_m *OCRConfig) BootstrapP2PIDs() [][32]byte {
	ret := _m.Called()

	if len(ret) == 0 {
		panic("no return value specified for BootstrapP2PIDs")
	}
...
func (_m *OCRConfig) OfframpAddress() []byte {
	ret := _m.Called()
...
// P2PIDs provides a mock function with given fields:
func (_m *OCRConfig) P2PIDs() [][32]byte {
	ret := _m.Called()

	if len(ret) == 0 {
		panic("no return value specified for P2PIDs")
	}
...
func (_m *OCRConfig) Signers() [][]byte {
	ret := _m.Called()
...
func (_m *OCRConfig) Transmitters() [][]byte {
	ret := _m.Called()
