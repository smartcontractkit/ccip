...
func (_m *OracleCreator) CreateCommitOracle(config types.OCR3ConfigWithMeta) (types.CCIPOracle, error) {
	ret := _m.Called(config)
...
func (_m *OracleCreator) CreateExecOracle(config types.OCR3ConfigWithMeta) (types.CCIPOracle, error) {
	ret := _m.Called(config)
