...
//go:generate go run ../generation/generate/wrap.go ../../../contracts/solc/v0.8.19/LinkTokenInterface.abi ../../../contracts/solc/v0.8.19/LinkTokenInterface.bin LinkTokenInterface link_token_interface
