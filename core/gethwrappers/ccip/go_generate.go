...
//go:generate go run ../generation/generate/wrap.go ../../../contracts/solc/v0.8.19/BurnMintWhitelistedTokenPool/BurnMintWhitelistedTokenPool.abi ../../../contracts/solc/v0.8.19/BurnMintWhitelistedTokenPool/BurnMintWhitelistedTokenPool.bin BurnMintWhitelistedTokenPool burn_mint_whitelisted_token_pool
