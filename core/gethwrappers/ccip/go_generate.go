...
//go:generate go run ../generation/generate/wrap.go ../../../contracts/solc/v0.8.19/MockUSDCTokenMessenger/MockUSDCTokenMessenger.abi ../../../contracts/solc/v0.8.19/MockUSDCTokenMessenger/MockUSDCTokenMessenger.bin MockUSDCTokenMessenger mock_usdc_token_messenger
//go:generate go run ../generation/generate/wrap.go ../../../contracts/solc/v0.8.19/MockUSDCTransmitter/MockUSDCTransmitter.abi ../../../contracts/solc/v0.8.19/MockUSDCTransmitter/MockUSDCTransmitter.bin MockUSDCTransmitter mock_usdc_token_transmitter
