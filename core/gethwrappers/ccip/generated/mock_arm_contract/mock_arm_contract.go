...
func (_MockARMContract *MockARMContractCaller) GetConfigDetails(opts *bind.CallOpts) (GetConfigDetails,
	...
	outstruct.Config = *abi.ConvertType(out[2], new(RMN1Config)).(*RMN1Config)
...
func (_MockARMContract *MockARMContractTransactor) OwnerUnvoteToCurse(opts *bind.TransactOpts, arg0 []RMN1UnvoteToCurseRecord, subject [16]byte) (*types.Transaction, error) {
	return _MockARMContract.contract.Transact(opts, "ownerUnvoteToCurse", arg0, subject)
}

func (_MockARMContract *MockARMContractSession) OwnerUnvoteToCurse(arg0 []RMN1UnvoteToCurseRecord, subject [16]byte) (*types.Transaction, error) {
	return _MockARMContract.Contract.OwnerUnvoteToCurse(&_MockARMContract.TransactOpts, arg0, subject)
}

func (_MockARMContract *MockARMContractTransactorSession) OwnerUnvoteToCurse(arg0 []RMN1UnvoteToCurseRecord, subject [16]byte) (*types.Transaction, error) {
	return _MockARMContract.Contract.OwnerUnvoteToCurse(&_MockARMContract.TransactOpts, arg0, subject)
}

func (_MockARMContract *MockARMContractTransactor) OwnerUnvoteToCurse0(opts *bind.TransactOpts, arg0 []RMN1UnvoteToCurseRecord) (*types.Transaction, error) {
	return _MockARMContract.contract.Transact(opts, "ownerUnvoteToCurse0", arg0)
}

func (_MockARMContract *MockARMContractSession) OwnerUnvoteToCurse0(arg0 []RMN1UnvoteToCurseRecord) (*types.Transaction, error) {
	return _MockARMContract.Contract.OwnerUnvoteToCurse0(&_MockARMContract.TransactOpts, arg0)
}

func (_MockARMContract *MockARMContractTransactorSession) OwnerUnvoteToCurse0(arg0 []RMN1UnvoteToCurseRecord) (*types.Transaction, error) {
	return _MockARMContract.Contract.OwnerUnvoteToCurse0(&_MockARMContract.TransactOpts, arg0)
}
...
type MockARMContractInterface interface {
	...
	OwnerUnvoteToCurse(opts *bind.TransactOpts, arg0 []RMN1UnvoteToCurseRecord, subject [16]byte) (*types.Transaction, error)

	OwnerUnvoteToCurse0(opts *bind.TransactOpts, arg0 []RMN1UnvoteToCurseRecord) (*types.Transaction, error)
