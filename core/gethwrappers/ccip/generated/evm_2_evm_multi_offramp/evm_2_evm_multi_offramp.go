...
func (_EVM2EVMMultiOffRamp *EVM2EVMMultiOffRampCaller) GetLatestCommitSequenceNumber(opts *bind.CallOpts) (uint64, error) {
	var out []interface{}
	err := _EVM2EVMMultiOffRamp.contract.Call(opts, &out, "getLatestCommitSequenceNumber")
...
func (_EVM2EVMMultiOffRamp *EVM2EVMMultiOffRampSession) GetLatestCommitSequenceNumber() (uint64, error) {
	return _EVM2EVMMultiOffRamp.Contract.GetLatestCommitSequenceNumber(&_EVM2EVMMultiOffRamp.CallOpts)
}

func (_EVM2EVMMultiOffRamp *EVM2EVMMultiOffRampCallerSession) GetLatestCommitSequenceNumber() (uint64, error) {
	return _EVM2EVMMultiOffRamp.Contract.GetLatestCommitSequenceNumber(&_EVM2EVMMultiOffRamp.CallOpts)
}
...
type EVM2EVMMultiOffRampInterface interface {
	...
	GetLatestCommitSequenceNumber(opts *bind.CallOpts) (uint64, error)
