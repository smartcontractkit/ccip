...
func (_Router *RouterCaller) IsOffRamp(opts *bind.CallOpts, offRamp common.Address, sourceChainSelector uint64) (bool, error) {
	var out []interface{}
	err := _Router.contract.Call(opts, &out, "isOffRamp", offRamp, sourceChainSelector)
...
func (_Router *RouterSession) IsOffRamp(offRamp common.Address, sourceChainSelector uint64) (bool, error) {
	return _Router.Contract.IsOffRamp(&_Router.CallOpts, offRamp, sourceChainSelector)
}

func (_Router *RouterCallerSession) IsOffRamp(offRamp common.Address, sourceChainSelector uint64) (bool, error) {
	return _Router.Contract.IsOffRamp(&_Router.CallOpts, offRamp, sourceChainSelector)
}
...
type RouterInterface interface {
	...
	IsOffRamp(opts *bind.CallOpts, offRamp common.Address, sourceChainSelector uint64) (bool, error)
