...
func (_MessageHasher *MessageHasherCaller) Hash(opts *bind.CallOpts, message InternalEVM2EVMMessage, metadataHash [32]byte) ([32]byte, error) {
	var out []interface{}
	err := _MessageHasher.contract.Call(opts, &out, "hash", message, metadataHash)
...
func (_MessageHasher *MessageHasherSession) Hash(message InternalEVM2EVMMessage, metadataHash [32]byte) ([32]byte, error) {
	return _MessageHasher.Contract.Hash(&_MessageHasher.CallOpts, message, metadataHash)
}

func (_MessageHasher *MessageHasherCallerSession) Hash(message InternalEVM2EVMMessage, metadataHash [32]byte) ([32]byte, error) {
	return _MessageHasher.Contract.Hash(&_MessageHasher.CallOpts, message, metadataHash)
}
...
type MessageHasherInterface interface {
	Hash(opts *bind.CallOpts, message InternalEVM2EVMMessage, metadataHash [32]byte) ([32]byte, error)
