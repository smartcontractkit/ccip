...
func (d disabled) LogsDataWordIn(eventSig common.Hash, address common.Address, wordIndex int, wordValues []common.Hash, confs Confirmations, qopts ...pg.QOpt) ([]Log, error) {
	return nil, ErrDisabled
}
