...
type LogPoller interface {
	...
	LogsDataWordIn(eventSig common.Hash, address common.Address, wordIndex int, wordValues []common.Hash, confs Confirmations, qopts ...pg.QOpt) ([]Log, error)
}
...
func (lp *logPoller) LogsDataWordIn(eventSig common.Hash, address common.Address, wordIndex int, wordValues []common.Hash, confs Confirmations, qopts ...pg.QOpt) ([]Log, error) {
	return lp.orm.SelectLogsDataWordIn(eventSig, address, wordIndex, wordValues, confs, qopts...)
}
