...
func (r *SpecResolver) ToCCIPRelaySpec() (*CCIPRelaySpecResolver, bool) {
	...
	return &CCIPRelaySpecResolver{spec: *r.j.CCIPRelaySpec}, true
}

// ToCCIPExecutionSpec resolves to the CCIP Execution Spec Resolver
func (r *SpecResolver) ToCCIPExecutionSpec() (*CCIPExecutionSpecResolver, bool) {
	if r.j.Type != job.CCIPExecution {
		return nil, false
	}

	return &CCIPExecutionSpecResolver{spec: *r.j.CCIPExecutionSpec}, true
}
...
// CCIPRelaySpecResolver defines the CCIP Relay Spec Resolver
type CCIPRelaySpecResolver struct {
	spec job.CCIPRelaySpec
}

// ID resolves the CCIP Relay spec ID
func (r *CCIPRelaySpecResolver) ID() graphql.ID {
	return graphql.ID(stringutils.FromInt32(r.spec.ID))
}

// ContractID resolves CCIP Relay spec contract ID
func (r *CCIPRelaySpecResolver) ContractID() string {
	return r.spec.ContractID
}

// Relay resolves CCIP Relay spec relay
func (r *CCIPRelaySpecResolver) Relay() string {
	return string(r.spec.Relay)
}

// RelayConfig resolves the spec's relay config
func (r *CCIPRelaySpecResolver) RelayConfig() gqlscalar.Map {
	return gqlscalar.Map(r.spec.RelayConfig)
}

// P2PBootstrapPeers resolves the spec's p2p bootstrap peers
func (r *CCIPRelaySpecResolver) P2PBootstrapPeers() *[]string {
	if len(r.spec.P2PBootstrapPeers) == 0 {
		return nil
	}
...
// IsBootstrapPeer resolves whether spec is a bootstrap peer.
func (r *CCIPRelaySpecResolver) IsBootstrapPeer() bool {
	return r.spec.IsBootstrapPeer
}

// OCRKeyBundleID resolves the spec's key bundle id.
func (r *CCIPRelaySpecResolver) OCRKeyBundleID() *string {
	if !r.spec.OCRKeyBundleID.Valid {
		return nil
	}
...
// MonitoringEndpoint resolves the spec's monitoring endpoint
func (r *CCIPRelaySpecResolver) MonitoringEndpoint() *string {
	if !r.spec.MonitoringEndpoint.Valid {
		return nil
	}
...
// TransmitterID resolves the spec's transmitter id
func (r *CCIPRelaySpecResolver) TransmitterID() *string {
	if !r.spec.TransmitterID.Valid {
		return nil
	}
...
// BlockchainTimeout resolves the spec's blockchain timeout.
func (r *CCIPRelaySpecResolver) BlockchainTimeout() *string {
	if r.spec.BlockchainTimeout.Duration() == 0 {
		return nil
	}
...
// ContractConfigTrackerSubscribeInterval resolves the spec's tracker subscribe
// interval config.
func (r *CCIPRelaySpecResolver) ContractConfigTrackerSubscribeInterval() *string {
	if r.spec.ContractConfigTrackerSubscribeInterval.Duration() == 0 {
		return nil
	}
...
// ContractConfigTrackerPollInterval resolves the spec's contract tracker poll
// interval config.
func (r *CCIPRelaySpecResolver) ContractConfigTrackerPollInterval() *string {
	if r.spec.ContractConfigTrackerPollInterval.Duration() == 0 {
		return nil
	}
...
// ContractConfigConfirmations resolves the spec's confirmations config.
func (r *CCIPRelaySpecResolver) ContractConfigConfirmations() *int32 {
	if r.spec.ContractConfigConfirmations == 0 {
		return nil
	}
...
func (r *CCIPRelaySpecResolver) JuelsPerFeeCoinSource() *string {
...
// CreatedAt resolves the spec's created at timestamp.
func (r *CCIPRelaySpecResolver) CreatedAt() graphql.Time {
	return graphql.Time{Time: r.spec.CreatedAt}
}

// OnRampID resolves the spec's on ramp id
func (r *CCIPRelaySpecResolver) OnRampID() string {
	return r.spec.OnRampID
}

// OffRampID resolves the spec's off ramp id
func (r *CCIPRelaySpecResolver) OffRampID() string {
	return r.spec.OffRampID
}

// SourceEVMChainID resolves the spec's source EVM chain ID
func (r *CCIPRelaySpecResolver) SourceEVMChainID() *graphql.ID {
	if r.spec.SourceEVMChainID == nil {
		return nil
	}

	id := graphql.ID(r.spec.SourceEVMChainID.String())

	return &id
}

// DestEVMChainID resolves the spec's destination EVM chain ID
func (r *CCIPRelaySpecResolver) DestEVMChainID() *graphql.ID {
	if r.spec.DestEVMChainID == nil {
		return nil
	}

	id := graphql.ID(r.spec.DestEVMChainID.String())

	return &id
}

// CCIPExecutionSpecResolver defines the CCIP Execution Spec Resolver
type CCIPExecutionSpecResolver struct {
	spec job.CCIPExecutionSpec
}

// ID resolves the CCIP Execution spec ID
func (r *CCIPExecutionSpecResolver) ID() graphql.ID {
	return graphql.ID(stringutils.FromInt32(r.spec.ID))
}

// ContractID resolves CCIP Execution spec contract ID
func (r *CCIPExecutionSpecResolver) ContractID() string {
	return r.spec.ContractID
}

// Relay resolves CCIP Execution spec relay
func (r *CCIPExecutionSpecResolver) Relay() string {
	return string(r.spec.Relay)
}

// RelayConfig resolves the spec's relay config
func (r *CCIPExecutionSpecResolver) RelayConfig() gqlscalar.Map {
	return gqlscalar.Map(r.spec.RelayConfig)
}

// P2PBootstrapPeers resolves the spec's p2p bootstrap peers
func (r *CCIPExecutionSpecResolver) P2PBootstrapPeers() *[]string {
	if len(r.spec.P2PBootstrapPeers) == 0 {
		return nil
	}
...
// IsBootstrapPeer resolves whether spec is a bootstrap peer.
func (r *CCIPExecutionSpecResolver) IsBootstrapPeer() bool {
	return r.spec.IsBootstrapPeer
}

// OCRKeyBundleID resolves the spec's key bundle id.
func (r *CCIPExecutionSpecResolver) OCRKeyBundleID() *string {
	if !r.spec.OCRKeyBundleID.Valid {
		return nil
	}
...
// MonitoringEndpoint resolves the spec's monitoring endpoint
func (r *CCIPExecutionSpecResolver) MonitoringEndpoint() *string {
	if !r.spec.MonitoringEndpoint.Valid {
		return nil
	}
...
// TransmitterID resolves the spec's transmitter id
func (r *CCIPExecutionSpecResolver) TransmitterID() *string {
	if !r.spec.TransmitterID.Valid {
		return nil
	}
...
// BlockchainTimeout resolves the spec's blockchain timeout.
func (r *CCIPExecutionSpecResolver) BlockchainTimeout() *string {
	if r.spec.BlockchainTimeout.Duration() == 0 {
		return nil
	}
...
// ContractConfigTrackerSubscribeInterval resolves the spec's tracker subscribe
// interval config.
func (r *CCIPExecutionSpecResolver) ContractConfigTrackerSubscribeInterval() *string {
	if r.spec.ContractConfigTrackerSubscribeInterval.Duration() == 0 {
		return nil
	}
...
// ContractConfigTrackerPollInterval resolves the spec's contract tracker poll
// interval config.
func (r *CCIPExecutionSpecResolver) ContractConfigTrackerPollInterval() *string {
	if r.spec.ContractConfigTrackerPollInterval.Duration() == 0 {
		return nil
	}
...
// ContractConfigConfirmations resolves the spec's confirmations config.
func (r *CCIPExecutionSpecResolver) ContractConfigConfirmations() *int32 {
	if r.spec.ContractConfigConfirmations == 0 {
		return nil
	}
...
// JuelsPerFeeCoinSource resolves the spec's juels per fee coin source
func (r *CCIPExecutionSpecResolver) JuelsPerFeeCoinSource() *string {
	if r.spec.JuelsPerFeeCoinPipeline == "" {
		return nil
	}
...
// CreatedAt resolves the spec's created at timestamp.
func (r *CCIPExecutionSpecResolver) CreatedAt() graphql.Time {
	return graphql.Time{Time: r.spec.CreatedAt}
}

// OnRampID resolves the spec's On Ramp ID
func (r *CCIPExecutionSpecResolver) OnRampID() string {
	return r.spec.OnRampID
}

// OffRampID resolves the spec's Off Ramp ID
func (r *CCIPExecutionSpecResolver) OffRampID() string {
	return r.spec.OffRampID
}

// ExecutorID resolves the spec's Executor ID
func (r *CCIPExecutionSpecResolver) ExecutorID() string {
	return r.spec.ExecutorID
}

// SourceEVMChainID resolves the spec's coordinator address.
func (r *CCIPExecutionSpecResolver) SourceEVMChainID() *graphql.ID {
	if r.spec.SourceEVMChainID == nil {
		return nil
	}
...
// DestEVMChainID resolves the spec's coordinator address.
func (r *CCIPExecutionSpecResolver) DestEVMChainID() *graphql.ID {
	if r.spec.DestEVMChainID == nil {
		return nil
	}
