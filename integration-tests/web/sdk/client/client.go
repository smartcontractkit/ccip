...
type Client interface {
	...
	CreateFeedsManagerChainConfig(ctx context.Context, in generated.CreateFeedsManagerChainConfigInput) (*generated.CreateFeedsManagerChainConfigResponse, error)
