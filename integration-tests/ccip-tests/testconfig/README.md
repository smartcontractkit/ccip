...
- The test reads the default configuration from [ccip-default.toml](/integration-tests/ccip-tests/testconfig/tomls/ccip-default.toml). 
- The default can be overridden by specifying the test config in a separate file. 
  ...
  - Example override file - [override.toml.example](/integration-tests/ccip-tests/testconfig/examples/override.toml.example)
- If there are sensitive details like private keys, credentials in test config, they can be specified in a separate secret file. 
  ...
  - Example secret file - [secrets.toml.example](/integration-tests/ccip-tests/testconfig/examples/secrets.toml.example)
