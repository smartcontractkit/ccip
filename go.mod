...
require (
	...
	github.com/smartcontractkit/chainlink-ccip v0.0.0-20240729211818-87f9bb698f6e
	github.com/smartcontractkit/chainlink-common v0.2.1-0.20240731084739-df31f22be53f
