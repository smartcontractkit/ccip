...
func (p *Plugin) NewExecutionFactory(ctx context.Context, srcChainID int64, dstChainID int64, srcProvider types.CCIPExecProvider, dstProvider types.CCIPExecProvider) (types.ReportingPluginFactory, error) {
