...
test_need_operator_assets: ## Add blank file in web assets if operator ui has not been built
	...
	[ -f "./core/web/assets/index.html" ] || mkdir /go/pkg/mod/github.com/smartcontractkit/ccip/v2@v2.5.0-ccip1.1.0/core/web && touch /go/pkg/mod/github.com/smartcontractkit/ccip/v2@v2.5.0-ccip1.1.0/core/web/assets/index.html
