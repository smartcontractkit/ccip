...
interface Any2EVMMOOffRampRouterInterface is SubscriptionInterface, BaseOffRampRouterInterface {
  /**
   ...
   */
  function routeMessage(CrossChainMessageReceiverInterface receiver, CCIP.Any2EVMMOMessage calldata message) external;
