/**
 *Submitted for verification at Optimistic.Etherscan.io on 2023-06-29
 */
...
abstract contract OFTCoreV2 is NonblockingLzApp {
  ...
  function _encodeSendAndCallPayload(
    ...
    return
      abi.encodePacked(PT_SEND_AND_CALL, _toAddress, _amountSD, _addressToBytes32(_from), _dstGasForCall, _payload);
  }
...
// File contracts/token/oft/v2/fee/IOFTWithFee.sol
...
// File contracts/token/oft/v2/fee/Fee.sol
...
// File contracts/token/oft/v2/fee/BaseOFTWithFee.sol
...
contract OFTV2 is BaseOFTWithFee, ERC20 {
  ...
  constructor(
    ...
    address _lzEndpoint
  ) ERC20(_name, _symbol) BaseOFTWithFee(_lzEndpoint) {
...
// File contracts/gravita/GravitaDebtToken.sol
