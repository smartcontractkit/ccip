...
contract USDCTokenPool_setConfig is USDCTokenPoolSetup {
  ...
  function testSetConfigSuccess() public {
    ...
    vm.expectCall(address(s_usdcTokenPool.getToken()), abi.encodeWithSelector(IERC20.approve.selector, oldConfig.tokenMessenger, 0));
    vm.expectCall(address(s_usdcTokenPool.getToken()), abi.encodeWithSelector(IERC20.approve.selector, newMockUSDC, type(uint256).max));
