...
contract MerkleMultiProofTest is BaseTest {
  ...
  function test_SpecSync_gas() public {
  ...
  function test_Fuzz_MerkleRoot2(bytes32 left, bytes32 right) public {
  ...
  function test_MerkleRoot256() public {
  ...
  function test_Fuzz_MerkleMulti1of4(bytes32 leaf1, bytes32 proof1, bytes32 proof2) public {
  ...
  function test_Fuzz_MerkleMulti2of4(bytes32 leaf1, bytes32 leaf2, bytes32 proof1, bytes32 proof2) public {
    bytes32[] memory leaves = new bytes32[](2);
    leaves[0] = leaf1;
    leaves[1] = leaf2;
    bytes32[] memory proofs = new bytes32[](2);
  ...
  function test_Fuzz_MerkleMulti3of4(bytes32 leaf1, bytes32 leaf2, bytes32 leaf3, bytes32 proof) public {
  ...
  function test_Fuzz_MerkleMulti4of4(bytes32 leaf1, bytes32 leaf2, bytes32 leaf3, bytes32 leaf4) public {
  ...
  function test_MerkleRootSingleLeaf_Success() public {
    bytes32[] memory leaves = new bytes32[](1);
    leaves[0] = "root";
    bytes32[] memory proofs = new bytes32[](0);
