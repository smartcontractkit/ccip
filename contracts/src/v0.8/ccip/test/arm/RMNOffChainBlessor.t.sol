...
contract ConfigCompare is Test {
  function assertConfigEq(
    RMNOffChainBlessor.Config memory actualConfig,
    RMNOffChainBlessor.Config memory expectedConfig
  ) public pure {
    assertEq(actualConfig.voters.length, expectedConfig.voters.length);
    for (uint256 i = 0; i < expectedConfig.voters.length; ++i) {
      RMNOffChainBlessor.Voter memory expectedVoter = expectedConfig.voters[i];
      RMNOffChainBlessor.Voter memory actualVoter = actualConfig.voters[i];
...
// contract RMNOffChainBlessor_constructor is ConfigCompare, RMNSetup {
//   function test_Constructor_Success() public view {
//     RMNOffChainBlessor.Config memory expectedConfig = rmnConstructorArgs();
//     (uint32 actualVersion,, RMNOffChainBlessor.Config memory actualConfig) = s_rmn.getConfigDetails();
//     assertEq(actualVersion, 1);
//     assertConfigEq(actualConfig, expectedConfig);
//   }
// }

contract RMNOffChainBlessor_verifySignatures is RMNSetup {
  ...
  function _getFirstBlessVoterAndWeight() internal pure returns (address, uint8) {
    RMNOffChainBlessor.Config memory cfg = rmnConstructorArgs();
  ...
  function test_RootSuccess() public {
    ...
    s_root.rmnSignatures.push(
      vm.sign(keccak256(abi.encode(s_root.merkleRoot, s_root.interval.min, s_root.interval.max)), voter)
    );

    assertFalse(s_rmn.verifySignatures(s_root));
  }
  ...
  //     vm.expectRevert(RMNOffChainBlessor.VoteToBlessNoop.selector);
  //     s_rmn.voteToBless(makeTaggedRootSingleton(1));
  ...
  //     vm.startPrank(cfg.voters[0].blessVoteAddr);
  //     vm.expectRevert(RMNOffChainBlessor.VoteToBlessForbiddenDuringActiveGlobalCurse.selector);
  //     s_rmn.voteToBless(makeTaggedRootSingleton(12903));
  //   }

  //   function test_UnauthorizedVoter_Revert() public {
  //     vm.startPrank(STRANGER);
  //     vm.expectRevert(abi.encodeWithSelector(RMNOffChainBlessor.UnauthorizedVoter.selector, STRANGER));
  //     s_rmn.voteToBless(makeTaggedRootSingleton(12321));
  //   }
}

// contract RMNOffChainBlessor_ownerUnbless is RMNSetup {
...
// contract RMNOffChainBlessor_unvoteToCurse is RMNSetup {
...
//         abi.encodeWithSelector(RMNOffChainBlessor.UnauthorizedVoter.selector, unauthorized[i]);
//       vm.startPrank(unauthorized[i]);
//       {
//         // should fail when using the correct curses hash
//         RMNOffChainBlessor.UnvoteToCurseRequest[] memory reqs = new RMNOffChainBlessor.UnvoteToCurseRequest[](1);
//         reqs[0] = RMNOffChainBlessor.UnvoteToCurseRequest({subject: 0, cursesHash: s_cursesHash});
...
//         RMNOffChainBlessor.UnvoteToCurseRequest[] memory reqs = new RMNOffChainBlessor.UnvoteToCurseRequest[](1);
//         reqs[0] = RMNOffChainBlessor.UnvoteToCurseRequest({subject: 0, cursesHash: GARBAGE_CURSES_HASH});
//         vm.expectRevert(expectedRevert);
//         s_rmn.unvoteToCurse(reqs);
//       }
//     }
...
//     RMNOffChainBlessor.UnvoteToCurseRequest[] memory reqs = new RMNOffChainBlessor.UnvoteToCurseRequest[](1);
//     reqs[0] = RMNOffChainBlessor.UnvoteToCurseRequest({subject: 0, cursesHash: GARBAGE_CURSES_HASH});
//     vm.expectRevert(RMNOffChainBlessor.UnvoteToCurseNoop.selector);
//     s_rmn.unvoteToCurse(reqs);
//   }
...
//     RMNOffChainBlessor.Config memory cfg = rmnConstructorArgs();
//     vm.startPrank(OWNER);
//     RMNOffChainBlessor.OwnerUnvoteToCurseRequest[] memory reqs = new RMNOffChainBlessor.OwnerUnvoteToCurseRequest[](1);
//     reqs[0] = RMNOffChainBlessor.OwnerUnvoteToCurseRequest({
//       curseVoteAddr: cfg.voters[s_curser].curseVoteAddr,
//       unit: RMNOffChainBlessor.UnvoteToCurseRequest({subject: 0, cursesHash: s_cursesHash}),
//       forceUnvote: false
//     });
...
//     reqs[0] = RMNOffChainBlessor.OwnerUnvoteToCurseRequest({
//       curseVoteAddr: cfg.voters[s_curser].curseVoteAddr,
//       unit: RMNOffChainBlessor.UnvoteToCurseRequest({subject: 0, cursesHash: GARBAGE_CURSES_HASH}),
//       forceUnvote: false
//     });

//     vm.expectEmit();
//     emit RMNOffChainBlessor.SkippedUnvoteToCurse(
//       cfg.voters[s_curser].curseVoteAddr, 0, s_cursesHash, GARBAGE_CURSES_HASH
//     );
//     vm.expectRevert(RMNOffChainBlessor.UnvoteToCurseNoop.selector);
//     s_rmn.ownerUnvoteToCurse(reqs);
//   }
...
//         vm.prank(cfg.voters[i].curseVoteAddr);
//         RMNOffChainBlessor.UnvoteToCurseRequest[] memory reqs = new RMNOffChainBlessor.UnvoteToCurseRequest[](1);
//         reqs[0] = RMNOffChainBlessor.UnvoteToCurseRequest({subject: 0, cursesHash: makeCursesHash(makeCurseId(1))});
//         s_rmn.unvoteToCurse(reqs);
//       }
//     }
...
//     // owner lifts curse
//     {
//       RMNOffChainBlessor.OwnerUnvoteToCurseRequest[] memory ownerReq =
//         new RMNOffChainBlessor.OwnerUnvoteToCurseRequest[](1);
//       ownerReq[0] = RMNOffChainBlessor.OwnerUnvoteToCurseRequest({
//         curseVoteAddr: LIFT_CURSE_VOTE_ADDR,
//         unit: RMNOffChainBlessor.UnvoteToCurseRequest({subject: 0, cursesHash: 0}),
//         forceUnvote: false
//       });
//       vm.prank(OWNER);
...
// contract RMNOffChainBlessor_voteToCurse_2 is RMNSetup {
//   function initialConfig() internal pure returns (RMNOffChainBlessor.Config memory) {
//     RMNOffChainBlessor.Config memory cfg = RMNOffChainBlessor.Config({
//       voters: new RMNOffChainBlessor.Voter[](3),
//       blessWeightThreshold: 1,
//       curseWeightThreshold: 3
//     });
//     cfg.voters[0] = RMNOffChainBlessor.Voter({
//       blessVoteAddr: BLESS_VOTER_1,
//       curseVoteAddr: CURSE_VOTER_1,
//       blessWeight: 1,
//       curseWeight: 1
//     });
//     cfg.voters[1] = RMNOffChainBlessor.Voter({
//       blessVoteAddr: BLESS_VOTER_2,
//       curseVoteAddr: CURSE_VOTER_2,
//       blessWeight: 1,
//       curseWeight: 1
//     });
//     cfg.voters[2] = RMNOffChainBlessor.Voter({
...
//   function setUp() public override {
//     vm.prank(OWNER);
//     s_rmn = new RMNOffChainBlessor(initialConfig());
//   }
...
//     {
//       RMNOffChainBlessor.Config memory cfg = initialConfig();
...
//     {
//       RMNOffChainBlessor.Config memory cfg = initialConfig();
//       RMNOffChainBlessor.Voter[] memory voters = cfg.voters;
//       assembly {
//         mstore(voters, 1)
//       }
...
//             unit: RMNOffChainBlessor.UnvoteToCurseRequest({subject: 0, cursesHash: makeCursesHash(makeCurseId(1))}),
//             forceUnvote: false
//           });
//           vm.prank(OWNER);
//           s_rmn.ownerUnvoteToCurse(ownerReq);
...
// contract RMNOffChainBlessor_voteToCurse is RMNSetup {
...
//     vm.startPrank(voter);
//     vm.expectEmit();
//     emit RMNOffChainBlessor.VotedToCurse(
//       1, // configVersion
//       voter,
//       GLOBAL_CURSE_SUBJECT,
//       makeCurseId(123),
...
//     vm.expectEmit();
//     emit RMNOffChainBlessor.Cursed(1, 0, uint64(block.timestamp));
...
//     // reverts even when the RMNOffChainBlessor contract is cursed.
...
//     );
//     vm.expectEmit();
//     emit RMNOffChainBlessor.Cursed(
//       1, // configVersion
//       0, // subject
//       uint64(block.timestamp) // blockTimestamp
//     );
...
//     RMNOffChainBlessor.OwnerUnvoteToCurseRequest[] memory unvoteReqs =
//       new RMNOffChainBlessor.OwnerUnvoteToCurseRequest[](1);
//     unvoteReqs[0] = RMNOffChainBlessor.OwnerUnvoteToCurseRequest({
//       curseVoteAddr: OWNER_CURSE_VOTE_ADDR,
//       unit: RMNOffChainBlessor.UnvoteToCurseRequest({subject: 0, cursesHash: 0}),
//       forceUnvote: true // TODO: test with forceUnvote false also
//     });
//     vm.expectEmit();
//     emit RMNOffChainBlessor.CurseLifted(0);
...
//     vm.expectRevert(abi.encodeWithSelector(RMNOffChainBlessor.ReusedCurseId.selector, voter, makeCurseId(1)));
//     s_rmn.voteToCurse(makeCurseId(1), makeSubjects(0));
//   }
...
//     vm.expectRevert(RMNOffChainBlessor.SubjectsMustBeStrictlyIncreasing.selector);
...
//     vm.expectRevert(RMNOffChainBlessor.VoteToCurseNoop.selector);
//     s_rmn.voteToCurse(makeCurseId(1), new bytes16[](0));
//   }
// }

// contract RMNOffChainBlessor_ownerUnvoteToCurse is RMNSetup {
...
//   function makeOwnerUnvoteToCurseRequests()
//     internal
//     pure
//     returns (RMNOffChainBlessor.OwnerUnvoteToCurseRequest[] memory)
//   {
//     (address[] memory cursers,) = getCursersAndCurseCounts();
//     RMNOffChainBlessor.OwnerUnvoteToCurseRequest[] memory reqs =
//       new RMNOffChainBlessor.OwnerUnvoteToCurseRequest[](cursers.length);
//     for (uint256 i = 0; i < cursers.length; ++i) {
//       reqs[i] = RMNOffChainBlessor.OwnerUnvoteToCurseRequest({
//         curseVoteAddr: cursers[i],
//         unit: RMNOffChainBlessor.UnvoteToCurseRequest({subject: GLOBAL_CURSE_SUBJECT, cursesHash: bytes28(0)}),
//         forceUnvote: true
//       });
//     }
//     return reqs;
...
//     vm.expectEmit();
//     emit RMNOffChainBlessor.CurseLifted(GLOBAL_CURSE_SUBJECT);
...
//     vm.prank(OWNER);
//     vm.expectEmit();
//     emit RMNOffChainBlessor.SkippedUnvoteToCurse(STRANGER, GLOBAL_CURSE_SUBJECT, bytes28(0), bytes28(0));
//     vm.expectRevert(RMNOffChainBlessor.UnvoteToCurseNoop.selector);
//     s_rmn.ownerUnvoteToCurse(reqs);
...
// contract RMNOffChainBlessor_setConfig is ConfigCompare, RMNSetup {
//   /// @notice Test-specific function to use only in setConfig tests
//   function getDifferentConfigArgs() private pure returns (RMNOffChainBlessor.Config memory) {
//     RMNOffChainBlessor.Voter[] memory voters = new RMNOffChainBlessor.Voter[](2);
//     voters[0] = RMNOffChainBlessor.Voter({
//       blessVoteAddr: BLESS_VOTER_1,
//       curseVoteAddr: CURSE_VOTER_1,
//       blessWeight: WEIGHT_1,
//       curseWeight: WEIGHT_1
//     });
//     voters[1] = RMNOffChainBlessor.Voter({
//       blessVoteAddr: BLESS_VOTER_2,
//       curseVoteAddr: CURSE_VOTER_2,
//       blessWeight: WEIGHT_10,
//       curseWeight: WEIGHT_10
//     });
//     return RMNOffChainBlessor.Config({
//       voters: voters,
...
//   event ConfigSet(uint32 indexed configVersion, RMNOffChainBlessor.Config config);
...
//     RMNOffChainBlessor.Config memory cfg = getDifferentConfigArgs();
//     vm.startPrank(OWNER);
//     s_rmn.setConfig(cfg);

//     // BLESS_VOTER_4 is not part of cfg anymore, vote to bless should revert.
//     vm.startPrank(BLESS_VOTER_4);
//     vm.expectRevert(abi.encodeWithSelector(RMNOffChainBlessor.UnauthorizedVoter.selector, BLESS_VOTER_4));
...
//     (uint32 configVersionAfter,, RMNOffChainBlessor.Config memory configAfter) = s_rmn.getConfigDetails();
...
//     vm.startPrank(OWNER);
//     vm.expectRevert(RMNOffChainBlessor.InvalidConfig.selector);
//     s_rmn.setConfig(
//       RMNOffChainBlessor.Config({
//         voters: new RMNOffChainBlessor.Voter[](0),
//         blessWeightThreshold: 1,
...
// contract RMNOffChainBlessor_permaBlessing is RMNSetup {
...
// contract RMNOffChainBlessor_getRecordedCurseRelatedOps is RMNSetup {
...
//     RMNOffChainBlessor.RecordedCurseRelatedOp[] memory recordedCurseRelatedOps =
//       s_rmn.getRecordedCurseRelatedOps(0, type(uint256).max);
//     assertEq(recordedCurseRelatedOps.length, 1);
//     assertEq(uint8(recordedCurseRelatedOps[0].tag), uint8(RMNOffChainBlessor.RecordedCurseRelatedOpTag.SetConfig));
//   }
// }
