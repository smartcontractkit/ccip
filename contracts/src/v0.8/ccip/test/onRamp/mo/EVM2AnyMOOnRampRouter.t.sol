...
import "./EVM2EVMMOOnRampSetup.t.sol";

/// @notice #constructor
contract EVM2AnyMOOnRampRouter_constructor is EVM2EVMMOOnRampSetup {
  function testSuccess() public {
    // typeAndVersion
    assertEq("EVM2AnyMOOnRampRouter 1.0.0", s_onRampRouter.typeAndVersion());
...
/// @notice #ccipSend
contract EVM2AnyMOOnRampRouter_ccipSend is EVM2EVMMOOnRampSetup {
  // Success
...
/// @notice #setOnRamp
contract EVM2AnyMOOnRampRouter_setOnRamp is EVM2EVMMOOnRampSetup {
  // Success

  // Asserts that setOnRamp changes the configured onramp. Also tests getOnRamp
  // and isChainSupported.
  function testSuccess() public {
    Any2EVMMOOnRampInterface onramp = Any2EVMMOOnRampInterface(address(1));
    uint256 chainId = 1337;
    Any2EVMMOOnRampInterface before = s_onRampRouter.getOnRamp(chainId);
    ...
    Any2EVMMOOnRampInterface afterSet = s_onRampRouter.getOnRamp(chainId);
  ...
  function testAlreadySetReverts() public {
    vm.expectRevert(
      abi.encodeWithSelector(Any2EVMMOOnRampRouterInterface.OnRampAlreadySet.selector, DEST_CHAIN_ID, s_onRamp)
    );
  ...
  function testOnlyOwnerReverts() public {
    ...
    s_onRampRouter.setOnRamp(1337, Any2EVMMOOnRampInterface(address(1)));
  }
}

/// @notice #setFee
contract EVM2AnyMOOnRampRouter_setFee is EVM2EVMMOOnRampSetup {
  // Success
  ...
  function testOnlyFeeAdminReverts() public {
    vm.stopPrank();
    vm.expectRevert(Any2EVMMOOnRampRouterInterface.OnlyCallableByFeeAdmin.selector);
    s_onRampRouter.setFee(1);
  }
}

/// @notice #fundSubscription
contract EVM2AnyMOOnRampRouter_fundSubscription is EVM2EVMMOOnRampSetup {
  // Success
...
contract EVM2AnyMOOnRampRouter_unfundSubscription is EVM2EVMMOOnRampSetup {
...
contract EVM2AnyMOOnRampRouter_isChainSupported is EVM2EVMMOOnRampSetup {
  // Success
  function testSuccess() public {
