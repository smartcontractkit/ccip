...
import "../vendor/openzeppelin-solidity/v4.8.3/contracts/utils/cryptography/MerkleProof.sol";
import "../vendor/openzeppelin-solidity/v4.8.3/contracts/access/Ownable2Step.sol";
import "../vendor/openzeppelin-solidity/v4.8.3/contracts/utils/cryptography/ECDSA.sol";
...
contract ManyChainMultiSig is Ownable2Step {
    ...
    /// ../vendor/openzeppelin-solidity/v4.8.3/contracts/contracts/utils/cryptography/MerkleProof.sol:15 for details.
    struct RootMetadata {
