...
contract CrossChainERC20Extension is ERC20, OwnerIsCreator, IERC2771Recipient {
    ...
    /// @inheritdoc IERC2771Recipient
    function _msgSender() internal override(Context, IERC2771Recipient) view returns (address ret) {
    ...
    /// @inheritdoc IERC2771Recipient
    function _msgData() internal override(Context, IERC2771Recipient) view returns (bytes calldata ret) {
        if (msg.data.length >= 20 && isTrustedForwarder(msg.sender)) {
