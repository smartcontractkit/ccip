...
abstract contract OptimismL1BridgeAdapterEncoder {
  function encodeFinalizeWithdrawalERC20Payload(OptimismL1BridgeAdapter.FinalizeWithdrawERC20Payload memory payload)
    public
    pure
  {}

  function encodeOptimismProveWithdrawalPayload(OptimismL1BridgeAdapter.OptimismProveWithdrawalPayload memory payload)
    public
    pure
  {}

  function encodeOptimismFinalizationPayload(OptimismL1BridgeAdapter.OptimismFinalizationPayload memory payload)
    public
    pure
  {}
}
